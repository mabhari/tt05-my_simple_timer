// This is taken from https://github.com/TinyTapeout/tt05-verilog-demo/blob/main/src/Makefile
# Makefile
...
VERILOG_SOURCES += $(PWD)/tb.v $(PWD)/tt_um_seven_segment_seconds.v $(PWD)/decoder.v
